...
const linkClass =
  "o-focus rounded text-sm o-footer-muted transition-colors hover:text-white";
      ...
      <div className="o-container py-12 md:py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
              ...
              <div className="mt-5 flex gap-2.5">
                {socialMedia.facebook && (
                  <a
                    ...
                    aria-label="Facebook"
                    className="o-focus flex size-9 items-center justify-center rounded-lg border border-white/15 o-footer-muted transition-colors hover:border-brand-400 hover:bg-brand-600 hover:text-white"
                  >
          ...
          <div>
            ...
            <address className="space-y-2.5 not-italic text-sm o-footer-muted">
              <p>
            ...
            <dl className="mt-5 space-y-1 text-sm o-footer-faint">
        ...
        <div className="mt-12 border-t border-white/10 pt-6">
          {/* El copyright estaba en brand-100/30 sobre brand-950: por
              debajo del contraste mínimo legible. */}
          <p className="text-sm o-footer-faint">
