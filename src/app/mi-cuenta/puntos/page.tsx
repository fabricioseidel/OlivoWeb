...
export default function PuntosPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-10">
        <h1 className="o-h1 mb-1 text-neutral-900">Club OlivoMarket</h1>
        ...
        <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-xl shadow-gray-200/50 flex flex-col justify-center">
           ...
           <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                 ...
                 <span className="tabular font-semibold text-red-600">−{totalRedeemed.toLocaleString()}</span>
              </div>
           </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-gray-200/50">
         <h2 className="o-h2 mb-5 text-neutral-900">Historial de movimientos</h2>
         {history.length > 0 ? (
           <div className="space-y-4">
             {history.map((tx: any) => (
