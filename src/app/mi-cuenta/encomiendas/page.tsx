...
const serviciosMain = [
  {
    ...
    title: "Recibe",
    description:
      "Retira tus compras online de forma segura. Somos punto pick-up oficial.",
  ...
  },
  {
    ...
    title: "Envía",
    description:
      "Despacha tus ventas o envíos personales de manera rápida y sin filas.",
  ...
  },
  {
    ...
    title: "Devuelve",
    description:
      "Gestiona devoluciones de tus compras de MercadoLibre fácilmente.",
...
export default function EncomiendасPage() {
  const { status } = useSession();
  const router = useRouter();

  useEffect(() => {
    if (status === "unauthenticated") {
      router.push("/login?callbackUrl=/mi-cuenta/encomiendas");
    }
  }, [status, router]);
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-8">
        <Link
          href="/mi-cuenta"
          className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-emerald-600 font-bold uppercase tracking-widest mb-6 transition-colors"
        >
          <ArrowLeftIcon className="w-4 h-4" />
          Mi Cuenta
        </Link>
        <div className="bg-gradient-to-br from-emerald-700 to-emerald-950 rounded-[2rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-emerald-900/30">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full blur-3xl -mr-20 -mt-20" />
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-emerald-400/10 rounded-full blur-2xl -ml-10 -mb-10" />
          <div className="relative z-10">
            ...
            <p className="text-emerald-100/80 font-medium max-w-lg leading-relaxed">
              Recibe, Envía y Devuelve tus encomiendas en Olivo Market. La
              solución inteligente para tus envíos diarios.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="mb-8">
        <div className="bg-white rounded-[2rem] border border-yellow-100 shadow-sm p-8">
          ...
          <p className="text-gray-600 mb-5 text-sm">
            Somos el punto neurálgico para usuarios de MercadoLibre en la zona.
          </p>
        ...
        <div className="bg-white rounded-[2rem] border border-cyan-100 shadow-sm p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600">
            <p className="bg-cyan-50 rounded-2xl p-4 border border-cyan-100 leading-relaxed">
              Contamos con un <strong className="text-cyan-700">Tótem de Impresión</strong> de etiquetas en el local. Ya no necesitas imprimir en casa.
            </p>
            <p className="bg-cyan-50 rounded-2xl p-4 border border-cyan-100 leading-relaxed">
              Ofrecemos <strong className="text-cyan-700">pago en caja</strong> para todas las encomiendas que envíes a través de nuestro punto Bluexpress.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white rounded-[2rem] border border-orange-100 shadow-sm p-8 flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Días de resguardo seguro. Si no retiras en este plazo, tu paquete se devuelve automáticamente al remitente.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-[2rem] p-10 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-black mb-3">¿Dudas?</h2>
            <p className="text-gray-300 font-medium mb-6 max-w-sm mx-auto leading-relaxed">
              Visítanos y consulta con nuestro equipo en caja. Estamos para ayudarte con todos tus envíos.
            </p>
