    ...
    <div className="mb-10">
      <div className="flex items-center justify-center max-w-md mx-auto">
        <div className={`flex items-center ${currentStep >= 1 ? 'text-blue-600' : 'text-gray-400'} relative`}>
          <div className={`rounded-full h-10 w-10 flex items-center justify-center border-2 font-semibold ${currentStep >= 1 ? 'border-blue-600 bg-blue-600 text-white' : 'border-gray-300 bg-white'}`}>
            {currentStep > 1 ? '✓' : '1'}
          </div>
        ...
        <div className={`flex items-center relative ${currentStep >= 2 ? "text-blue-600" : "text-gray-400"}`}>
          <div className={`rounded-full h-10 w-10 flex items-center justify-center border-2 font-semibold ${currentStep >= 2 ? "border-blue-600 bg-blue-600 text-white" : "border-gray-300 bg-white"}`}>
            2
          </div>
