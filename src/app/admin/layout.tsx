...
const menuGroupsOlivoTeam: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: "POS", href: "/admin/pos", icon: UserCircleIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Edición Masiva", href: "/admin/productos/edicion-masiva", icon: SparklesIcon },
    ],
  },
];
...
const menuGroupsLaboratorioFabri: MenuGroup[] = [
  ...
  },
  {
    label: "Uber Eats",
    items: [
      { name: "Uber Eats", href: "/admin/uber-eats", icon: ClipboardDocumentListIcon },
    ],
  },
  {
    label: "Compras",
    items: [
      ...
      { name: "Reabastecimiento", href: "/admin/reabastecimiento", icon: ShoppingCartIcon },
    ],
  },
];

const allItems = [
  ...menuGroupsOlivoTeam.flatMap(g => g.items),
  ...menuGroupsLaboratorioFabri.flatMap(g => g.items)
];
